 ...
 *
 */
package com.biglybt.common.constant;
...
public class Constants
{
	...
	public static final Charset UTF_8 = Charset.forName(DEFAULT_ENCODING);
	...
	public static final char CHAR_TILDE = '~';//波浪号
	public static final char CHAR_POINT = '·';//点
	public static final char CHAR_BANG = '!';//叹号
	public static final char CHAR_AT = '@';//圈a
	public static final char CHAR_SHARP = '#';//井号
	public static final char CHAR_DOLLAR = '$';//美元符号
	public static final char CHAR_PERCENT = '%';//百分号号
	public static final char CHAR_CARET = '^';//插入符号
	public static final char CHAR_AMPERSAND = '&';//与号
	public static final char CHAR_STAR = '*';//与号
	public static final char CHAR_HYPHEN = '-';//减号，连字符
	public static final char CHAR_UNDERSCORE = '_';//加号
	public static final char CHAR_PLUS = '+';//加号
	public static final char CHAR_EQUAL = '=';//等号

	public static final char CHAR_VERTICAL = '|';
	public static final char CHAR_SINGLE_BACKSLASH = '\\';

	public static final char CHAR_SINGLE_QUOTE = '\'';
	public static final char CHAR_DOUBLE_QUOTE = '"';

	public static final char CHAR_COLON = ':';//冒号
	public static final char CHAR_SEMICOLON = ';';

	public static final char CHAR_COMMA = ',';//逗号
	public static final char CHAR_DOT = '.'; //点
	public static final char CHAR_QUESTION = '?';//问号
	public static final char CHAR_SINGLE_SLASH = '/';

	public static final char CHAR_SPACE= ' '; //空格

	public static final char CHAR_BRACKETS_ROUND_LEFT = '(';//左括号
	public static final char CHAR_BRACKETS_ROUND_RIGHT = ')';//右括号
	public static final char CHAR_BRACKETS_SQUARE_LEFT = '[';//左中括号
	public static final char CHAR_BRACKETS_SQUARE_RIGHT = ']';//右中括号
	public static final char CHAR_BRACKETS_CURLY_LEFT = '{';//左大括号
	public static final char CHAR_BRACKETS_CURLY_RIGHT = '}';//右大括号
	public static final char CHAR_BRACKETS_ANGLE_LEFT = '<';//左中括号
	public static final char CHAR_BRACKETS_ANGLE_RIGHT = '>';//右中括号

	public static final char CHAR_NOT = CHAR_BANG;//非
	public static final char CHAR_AND = CHAR_AMPERSAND;//与
	public static final char CHAR_OR = CHAR_VERTICAL; //或
	public static final char CHAR_XOR = CHAR_CARET; //异或

	public static final String S_DOUBLE_HYPHEN = String.valueOf(CHAR_HYPHEN) + CHAR_HYPHEN;
	public static final String S_DOUBLE_VERTICAL = String.valueOf(CHAR_VERTICAL) + CHAR_VERTICAL;
	public static final String S_DUBBLE_AMPERSAND = String.valueOf(CHAR_AMPERSAND) + CHAR_AMPERSAND;
	public static final String S_DUBBLE_EQUAL = String.valueOf(CHAR_EQUAL) + CHAR_EQUAL;
	public static final String S_DOUBLE_SLASH = String.valueOf(CHAR_SINGLE_SLASH) + CHAR_SINGLE_SLASH;
	public static final String S_DOUBLE_BACKSLASH = String.valueOf(CHAR_SINGLE_BACKSLASH) + CHAR_SINGLE_BACKSLASH;

	public static final String DEFAULT_HOLDER_LEFT = String.valueOf(CHAR_DOLLAR) + CHAR_BRACKETS_CURLY_LEFT;

	public static final String S_DOUBLE_BRACKETS_LEFT = String.valueOf(CHAR_BRACKETS_CURLY_LEFT) + CHAR_BRACKETS_CURLY_LEFT;
	public static final String S_DOUBLE_BRACKETS_RIGHT = String.valueOf(CHAR_BRACKETS_CURLY_RIGHT) + CHAR_BRACKETS_CURLY_RIGHT;
	public static final String S_DOUBLE_BRACKETS_LEFT_SPACE = String.valueOf(CHAR_BRACKETS_CURLY_LEFT) + CHAR_SPACE + CHAR_BRACKETS_CURLY_LEFT;
	public static final String S_DOUBLE_BRACKETS_RIGHT_SPACE = String.valueOf(CHAR_BRACKETS_CURLY_RIGHT) + CHAR_SPACE + CHAR_BRACKETS_CURLY_RIGHT;
	...
	public static final int    CRAPPY_INFINITY_AS_INT  = 31536000; // 365*24*3600; // seconds (365days)
	public static final long   CRAPPY_INFINITE_AS_LONG = 315360000000L; // 10000*365*24*3600; // seconds (10k years)
