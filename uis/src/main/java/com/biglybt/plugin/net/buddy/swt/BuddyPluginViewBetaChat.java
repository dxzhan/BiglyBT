...
import com.biglybt.plugin.net.buddy.BuddyPluginBeta.ChatListener;
import com.biglybt.plugin.net.buddy.BuddyPluginBeta.ChatMessage;
import com.biglybt.plugin.net.buddy.BuddyPluginBeta.ChatParticipant;
import com.biglybt.plugin.net.buddy.BuddyPluginBeta.FTUXStateChangeListener;
...
BuddyPluginViewBetaChat
	...
	private BuddyPluginViewBetaChat(
	...
	protected BuddyPluginViewBetaChat(
		BuddyPluginView _view,
		BuddyPlugin _plugin,
		ChatInstance _chat,
		Composite _parent) {
