...
public interface UISWTViewBuilder {
	 ...
	 *
	 * @param canHandleMultipleViews Whether the {@link UISWTViewEventListener} created can handle multiple {@link UISWTView}
	 * @param listenerInstantiator   called when a new {@link UISWTView} is created
	 * @since BiglyBT 2.1.0.1
	 */
