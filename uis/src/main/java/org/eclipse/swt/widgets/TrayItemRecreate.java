	...
	static {
		try {
			...
			if (claOS != null) {
				...
				claNOTIFYICONDATA = Class.forName("org.eclipse.swt.internal.win32.NOTIFYICONDATA");

				NOTIFYICONDATA_sizeof = claNOTIFYICONDATA.getField("sizeof").getInt(
					null);

				NOTIFYICONDATAA = Class.forName("org.eclipse.swt.internal.win32.NOTIFYICONDATAA");
				NOTIFYICONDATAW = Class.forName("org.eclipse.swt.internal.win32.NOTIFYICONDATAW");

				IS_64 = Class.forName("org.eclipse.swt.internal.library").getDeclaredField("IS_64").getBoolean(null);
			}
		} catch (Exception e) {
		}
	}
